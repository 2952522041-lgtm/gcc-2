...
(function () {
  ...
  (function () {
    ...
    var CATS = { ch01: '基础', ch02: '基础', ch03: '基础', ch04: '基础', ch05: '基础', ch06: '基础',
      ...
      ch13: '实战', ch14: '测验', ch15: '专题', ch16: '实战', ch17: '专题', ch18: '专题', ch19: '参考', ch20: '验收' };
    cards.forEach(function (c) {
  ...
  (function () {
    var T = {
      ...
      ch16: '迷你编译器', ch17: '交叉编译', ch18: '错误图鉴', ch19: '术语表', ch20: '结课验收'
    };
    var REL = {
      ...
      ch13: ['ch02', 'ch15', 'ch20'], ch14: ['ch01', 'ch19'], ch15: ['ch03', 'ch17'], ch16: ['ch05', 'ch11', 'ch20'],
      ch17: ['ch10', 'ch15'], ch18: ['ch06', 'ch10'], ch19: ['ch07', 'ch18'], ch20: ['ch16', 'ch13', 'ch12']
    };
  ...
  (function () {
    var Q = {
      ...
      ch20: ['结课验收项目规定必须用 C 语言实现编译器', '错 —— 语言不限（推荐 Python），验收看的是测试套件是否全部通过、验收报告是否完整（含 GCC 对比分析）。']
    };
